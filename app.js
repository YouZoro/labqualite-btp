...
// --- 6b. SVG TECHNICAL DIAGRAMS GENERATOR ---
function generateStepDiagram(testId, stepNum) {
    const key = `${testId}_${stepNum}`;
    const diagrams = {
        // SOLS - Teneur en eau
        'sol_teneur_eau_1': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="metal1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#C0C0C0"/><stop offset="100%" stop-color="#808080"/></linearGradient></defs><rect x="80" y="50" width="120" height="40" rx="3" fill="url(#metal1)" stroke="#555" stroke-width="1.5"/><text x="140" y="75" text-anchor="middle" font-size="11" fill="#333" font-weight="bold">Tare vide</text><rect x="20" y="30" width="50" height="80" rx="4" fill="#2196F3" opacity="0.2" stroke="#1565C0" stroke-width="1.5"/><text x="45" y="80" text-anchor="middle" font-size="9" fill="#1565C0">Balance</text><text x="45" y="65" text-anchor="middle" font-size="14" fill="#1565C0">⚖️</text><path d="M 200 100 L 260 100" stroke="#FF6F00" stroke-width="2" stroke-dasharray="5,3"/><text x="230" y="95" text-anchor="middle" font-size="9" fill="#FF6F00" font-weight="bold">M1</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Peser la tare vide → noter M1</text></svg>`,
        'sol_teneur_eau_2': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="soil1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#8B6914"/><stop offset="100%" stop-color="#5D4E37"/></linearGradient></defs><rect x="80" y="40" width="120" height="45" rx="3" fill="#AAA" stroke="#666" stroke-width="1.5"/><ellipse cx="140" cy="55" rx="50" ry="15" fill="url(#soil1)"/><circle cx="120" cy="52" r="3" fill="#6B5B3E" opacity="0.6"/><circle cx="145" cy="58" r="4" fill="#7B6B4E" opacity="0.5"/><circle cx="155" cy="50" r="2.5" fill="#8B7B5E" opacity="0.7"/><text x="140" y="75" text-anchor="middle" font-size="9" fill="#FFF" font-weight="bold">Sol humide + Tare</text><rect x="20" y="30" width="50" height="80" rx="4" fill="#2196F3" opacity="0.15" stroke="#1565C0" stroke-width="1.5"/><text x="45" y="72" text-anchor="middle" font-size="14" fill="#1565C0">⚖️</text><path d="M 200 90 L 260 90" stroke="#FF6F00" stroke-width="2" stroke-dasharray="5,3"/><text x="230" y="85" text-anchor="middle" font-size="9" fill="#FF6F00" font-weight="bold">M2</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Peser tare + sol humide → M2</text></svg>`,
        'sol_teneur_eau_3': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="90" y="20" width="100" height="90" rx="5" fill="#E65100" opacity="0.15" stroke="#E65100" stroke-width="2"/><text x="140" y="55" text-anchor="middle" font-size="12" fill="#E65100" font-weight="bold">ÉTUVE</text><text x="140" y="72" text-anchor="middle" font-size="10" fill="#E65100">110 ± 5 °C</text><text x="140" y="88" text-anchor="middle" font-size="9" fill="#BF360C">16-24 heures</text><circle cx="120" cy="42" r="5" fill="#FF5722" opacity="0.5"><animate attributeName="opacity" values="0.3;0.8;0.3" dur="1.5s" repeatCount="indefinite"/></circle><circle cx="160" cy="42" r="4" fill="#FF5722" opacity="0.5"><animate attributeName="opacity" values="0.5;1;0.5" dur="2s" repeatCount="indefinite"/></circle><path d="M 50 95 L 80 95 L 90 80" stroke="#1565C0" stroke-width="1.5" fill="none" marker-end="url(#arrow)"/><text x="55" y="115" text-anchor="middle" font-size="8" fill="#666">Placer</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Séchage à l'étuve 110°C</text></svg>`,
        'sol_teneur_eau_4': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="100" y="30" width="80" height="70" rx="20" fill="#E3F2FD" stroke="#1565C0" stroke-width="1.5"/><text x="140" y="60" text-anchor="middle" font-size="10" fill="#1565C0" font-weight="bold">Dessiccateur</text><text x="140" y="78" text-anchor="middle" font-size="9" fill="#42A5F5">Refroidissement</text><path d="M 60 70 C 60 40, 100 40, 100 60" stroke="#999" stroke-width="1.5" fill="none" stroke-dasharray="4,3"/><text x="60" y="85" text-anchor="middle" font-size="8" fill="#666">Sortir</text><text x="60" y="95" text-anchor="middle" font-size="8" fill="#666">étuve</text><circle cx="220" cy="50" r="12" fill="#E8F5E9" stroke="#4CAF50" stroke-width="1"/><text x="220" y="54" text-anchor="middle" font-size="10" fill="#4CAF50">❄️</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Refroidir sans absorber d'humidité</text></svg>`,
        'sol_teneur_eau_5': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="80" y="40" width="120" height="40" rx="3" fill="#D7CCC8" stroke="#795548" stroke-width="1.5"/><text x="140" y="65" text-anchor="middle" font-size="10" fill="#5D4037" font-weight="bold">Sol sec + Tare</text><rect x="20" y="30" width="50" height="80" rx="4" fill="#4CAF50" opacity="0.15" stroke="#4CAF50" stroke-width="1.5"/><text x="45" y="72" text-anchor="middle" font-size="14" fill="#4CAF50">⚖️</text><path d="M 200 85 L 260 85" stroke="#FF6F00" stroke-width="2" stroke-dasharray="5,3"/><text x="230" y="80" text-anchor="middle" font-size="9" fill="#FF6F00" font-weight="bold">M3</text><rect x="100" y="100" width="80" height="25" rx="4" fill="#E8F5E9" stroke="#4CAF50" stroke-width="1"/><text x="140" y="117" text-anchor="middle" font-size="9" fill="#2E7D32" font-weight="bold">w = (M2-M3)/(M3-M1) × 100</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Peser sol sec → calculer w%</text></svg>`,

        // SOLS - Atterberg
        'sol_atterberg_1': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="60" y="60" width="160" height="8" rx="2" fill="#1565C0" opacity="0.3"/><text x="140" y="55" text-anchor="middle" font-size="10" fill="#1565C0" font-weight="bold">Tamis 400 µm</text><ellipse cx="140" cy="35" rx="40" ry="15" fill="#8B6914" opacity="0.5"/><text x="140" y="39" text-anchor="middle" font-size="8" fill="#FFF">Sol brut</text><path d="M 120 68 L 110 100 M 140 68 L 140 100 M 160 68 L 170 100" stroke="#8B6914" stroke-width="1" opacity="0.5"/><text x="140" y="115" text-anchor="middle" font-size="9" fill="#795548">Fraction fine 0/400µm</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Préparer la fraction fine</text></svg>`,
        'sol_atterberg_2': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><ellipse cx="140" cy="60" rx="60" ry="25" fill="#A0887A" stroke="#795548" stroke-width="1.5"/><path d="M 190 45 L 210 30" stroke="#42A5F5" stroke-width="2"/><circle cx="215" cy="25" r="8" fill="#42A5F5" opacity="0.3"/><text x="215" y="28" text-anchor="middle" font-size="8" fill="#1565C0">💧</text><text x="140" y="63" text-anchor="middle" font-size="9" fill="#FFF" font-weight="bold">Pâte homogène</text><text x="140" y="100" text-anchor="middle" font-size="9" fill="#795548">Mélange sol + eau</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Former une pâte plastique</text></svg>`,
        'sol_atterberg_3': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><path d="M 60 80 Q 140 20 220 80" fill="#D7CCC8" stroke="#795548" stroke-width="2"/><line x1="140" y1="25" x2="140" y2="80" stroke="#E65100" stroke-width="2" stroke-dasharray="3,3"/><text x="140" y="18" text-anchor="middle" font-size="8" fill="#E65100" font-weight="bold">Rainure</text><text x="80" y="95" text-anchor="middle" font-size="8" fill="#795548">Coupelle</text><text x="200" y="95" text-anchor="middle" font-size="8" fill="#795548">Casagrande</text><path d="M 220 100 L 240 110 L 260 100" stroke="#666" stroke-width="1.5" fill="none"/><text x="240" y="125" text-anchor="middle" font-size="8" fill="#666">Manivelle</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">WL : Coupelle de Casagrande</text></svg>`,
        'sol_atterberg_4': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="60" y="50" width="160" height="10" rx="2" fill="#BDBDBD" stroke="#757575" stroke-width="1"/><text x="140" y="45" text-anchor="middle" font-size="9" fill="#757575">Plaque de marbre</text><line x1="80" y1="48" x2="200" y2="48" stroke="#8B6914" stroke-width="3" stroke-linecap="round"/><text x="140" y="75" text-anchor="middle" font-size="9" fill="#795548" font-weight="bold">Rouleau ∅ 3 mm</text><path d="M 100 48 L 100 42 M 180 48 L 180 42" stroke="#E65100" stroke-width="1" stroke-dasharray="2,2"/><text x="140" y="40" text-anchor="middle" font-size="7" fill="#E65100">3mm</text><circle cx="110" cy="90" r="3" fill="#FF5722" opacity="0.5"/><circle cx="140" cy="90" r="2" fill="#FF5722" opacity="0.5"/><circle cx="165" cy="90" r="3.5" fill="#FF5722" opacity="0.5"/><text x="140" y="105" text-anchor="middle" font-size="8" fill="#FF5722">Fissuration = WP atteint</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">WP : Rouleaux 3mm → fissures</text></svg>`,

        // SOLS - Proctor
        'sol_proctor_1': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="30" y="40" width="40" height="50" rx="3" fill="#8B6914" opacity="0.6" stroke="#5D4E37" stroke-width="1"/><rect x="80" y="40" width="40" height="50" rx="3" fill="#8B6914" opacity="0.5" stroke="#5D4E37" stroke-width="1"/><rect x="130" y="40" width="40" height="50" rx="3" fill="#8B6914" opacity="0.4" stroke="#5D4E37" stroke-width="1"/><rect x="180" y="40" width="40" height="50" rx="3" fill="#8B6914" opacity="0.3" stroke="#5D4E37" stroke-width="1"/><rect x="230" y="40" width="40" height="50" rx="3" fill="#8B6914" opacity="0.2" stroke="#5D4E37" stroke-width="1"/><text x="50" y="70" text-anchor="middle" font-size="8" fill="#FFF">4%</text><text x="100" y="70" text-anchor="middle" font-size="8" fill="#FFF">6%</text><text x="150" y="70" text-anchor="middle" font-size="8" fill="#333">8%</text><text x="200" y="70" text-anchor="middle" font-size="8" fill="#333">10%</text><text x="250" y="70" text-anchor="middle" font-size="8" fill="#333">12%</text><text x="140" y="110" text-anchor="middle" font-size="9" fill="#1565C0" font-weight="bold">5 échantillons à w% différentes</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Préparer 5 teneurs en eau</text></svg>`,
        'sol_proctor_2': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="100" y="50" width="80" height="60" rx="4" fill="#BDBDBD" stroke="#757575" stroke-width="2"/><text x="140" y="85" text-anchor="middle" font-size="9" fill="#555" font-weight="bold">Moule</text><rect x="120" y="15" width="10" height="35" rx="2" fill="#795548" stroke="#5D4E37" stroke-width="1.5"/><text x="125" y="10" text-anchor="middle" font-size="8" fill="#E65100" font-weight="bold">Dame</text><path d="M 125 50 L 125 60" stroke="#FF5722" stroke-width="2" marker-end="url(#arrowR)"/><text x="200" y="45" text-anchor="middle" font-size="8" fill="#FF6F00">25 coups</text><text x="200" y="57" text-anchor="middle" font-size="8" fill="#FF6F00">× 3 couches</text><line x1="100" y1="70" x2="180" y2="70" stroke="#8B6914" stroke-width="1" stroke-dasharray="2,2"/><line x1="100" y1="82" x2="180" y2="82" stroke="#8B6914" stroke-width="1" stroke-dasharray="2,2"/><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Compacter en couches</text></svg>`,
        'sol_proctor_3': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="90" y="40" width="100" height="50" rx="4" fill="#BDBDBD" stroke="#757575" stroke-width="2"/><line x1="80" y1="40" x2="210" y2="40" stroke="#1565C0" stroke-width="2"/><text x="140" y="35" text-anchor="middle" font-size="8" fill="#1565C0" font-weight="bold">Règle à araser</text><rect x="30" y="40" width="45" height="60" rx="3" fill="#2196F3" opacity="0.15" stroke="#1565C0" stroke-width="1.5"/><text x="52" y="75" text-anchor="middle" font-size="12" fill="#1565C0">⚖️</text><text x="140" y="110" text-anchor="middle" font-size="9" fill="#FF6F00" font-weight="bold">→ Masse volumique humide</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Araser et peser</text></svg>`,
        'sol_proctor_4': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="90" y="30" width="100" height="50" rx="4" fill="#BDBDBD" stroke="#757575" stroke-width="1.5"/><circle cx="120" cy="55" r="10" fill="#8B6914" opacity="0.5"/><circle cx="160" cy="55" r="10" fill="#8B6914" opacity="0.5"/><text x="140" y="95" text-anchor="middle" font-size="9" fill="#795548">Carottes de sol</text><path d="M 140 80 L 140 100" stroke="#FF6F00" stroke-width="1.5" stroke-dasharray="3,2"/><text x="140" y="115" text-anchor="middle" font-size="9" fill="#1565C0" font-weight="bold">→ Teneur en eau réelle</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Prélever pour mesure w%</text></svg>`,
        'sol_proctor_5': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><line x1="40" y1="110" x2="250" y2="110" stroke="#666" stroke-width="1.5"/><line x1="40" y1="20" x2="40" y2="110" stroke="#666" stroke-width="1.5"/><text x="145" y="128" text-anchor="middle" font-size="8" fill="#666">Teneur en eau w%</text><text x="25" y="65" text-anchor="middle" font-size="7" fill="#666" transform="rotate(-90,25,65)">γd</text><path d="M 60 100 Q 100 80 140 40 Q 170 50 220 95" fill="none" stroke="#1565C0" stroke-width="2.5"/><circle cx="140" cy="40" r="5" fill="#FF6F00" stroke="#E65100" stroke-width="1.5"/><text x="155" y="35" font-size="8" fill="#FF6F00" font-weight="bold">OPM</text><line x1="140" y1="45" x2="140" y2="110" stroke="#FF6F00" stroke-width="1" stroke-dasharray="3,3"/><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Courbe Proctor → w_opt</text></svg>`,

        // SOLS - CBR
        'sol_cbr_1': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="90" y="40" width="100" height="60" rx="5" fill="#BDBDBD" stroke="#757575" stroke-width="2"/><ellipse cx="140" cy="55" rx="40" ry="12" fill="#8B6914" opacity="0.6"/><text x="140" y="59" text-anchor="middle" font-size="8" fill="#FFF">Sol compacté</text><text x="140" y="85" text-anchor="middle" font-size="9" fill="#555">Moule CBR</text><text x="140" y="115" text-anchor="middle" font-size="9" fill="#1565C0" font-weight="bold">à l'OPM</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Compacter au moule CBR</text></svg>`,
        'sol_cbr_2': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="70" y="50" width="140" height="40" rx="4" fill="#42A5F5" opacity="0.2" stroke="#1565C0" stroke-width="1.5"/><text x="140" y="75" text-anchor="middle" font-size="10" fill="#1565C0" font-weight="bold">Bac d'immersion 💧</text><rect x="100" y="55" width="80" height="30" rx="3" fill="#BDBDBD" stroke="#757575" stroke-width="1.5"/><text x="140" y="48" text-anchor="middle" font-size="8" fill="#FF6F00">96 heures (4 jours)</text><text x="140" y="110" text-anchor="middle" font-size="9" fill="#795548">Comparateur de gonflement</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Immersion + mesure gonflement</text></svg>`,
        'sol_cbr_3': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="110" y="10" width="60" height="90" rx="3" fill="#E0E0E0" stroke="#757575" stroke-width="2"/><text x="140" y="55" text-anchor="middle" font-size="9" fill="#555" font-weight="bold">Presse</text><rect x="120" y="80" width="40" height="20" rx="2" fill="#BDBDBD" stroke="#757575" stroke-width="1.5"/><text x="140" y="94" text-anchor="middle" font-size="7" fill="#555">Moule</text><path d="M 140 10 L 140 80" stroke="#FF5722" stroke-width="2" marker-end="url(#arrowR)"/><text x="140" y="120" text-anchor="middle" font-size="9" fill="#1565C0" font-weight="bold">Poinçonnement CBR</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Placer sous la presse</text></svg>`,
        'sol_cbr_4': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="110" y="50" width="60" height="40" rx="2" fill="#BDBDBD" stroke="#757575" stroke-width="1.5"/><circle cx="120" cy="45" r="8" fill="#FF6F00" opacity="0.3"/><circle cx="140" cy="45" r="8" fill="#FF6F00" opacity="0.3"/><circle cx="160" cy="45" r="8" fill="#FF6F00" opacity="0.3"/><text x="140" y="48" text-anchor="middle" font-size="7" fill="#E65100" font-weight="bold">Surcharges</text><text x="140" y="110" text-anchor="middle" font-size="9" fill="#1565C0">Appliquer surcharges annulaires</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Surcharges + démarrer pénétration</text></svg>`,
        'sol_cbr_5': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><line x1="40" y1="105" x2="240" y2="105" stroke="#666" stroke-width="1.5"/><line x1="40" y1="20" x2="40" y2="105" stroke="#666" stroke-width="1.5"/><text x="140" y="125" text-anchor="middle" font-size="8" fill="#666">Enfoncement (mm)</text><text x="25" y="60" text-anchor="middle" font-size="7" fill="#666" transform="rotate(-90,25,60)">Force</text><path d="M 40 105 Q 80 85 120 55 L 200 30" fill="none" stroke="#1565C0" stroke-width="2"/><line x1="95" y1="105" x2="95" y2="65" stroke="#FF6F00" stroke-width="1" stroke-dasharray="3,3"/><text x="95" y="115" text-anchor="middle" font-size="7" fill="#FF6F00">2.5mm</text><line x1="155" y1="105" x2="155" y2="42" stroke="#4CAF50" stroke-width="1" stroke-dasharray="3,3"/><text x="155" y="115" text-anchor="middle" font-size="7" fill="#4CAF50">5.0mm</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Noter forces à 2.5 et 5.0 mm</text></svg>`,

        // SOLS - VBS
        'sol_vbs_1': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="90" y="40" width="100" height="50" rx="4" fill="#8B6914" opacity="0.3" stroke="#795548" stroke-width="1.5"/><text x="140" y="70" text-anchor="middle" font-size="10" fill="#5D4037" font-weight="bold">Sol sec Ms=200g</text><circle cx="220" cy="65" r="15" fill="#42A5F5" opacity="0.2" stroke="#1565C0" stroke-width="1"/><text x="220" y="69" text-anchor="middle" font-size="8" fill="#1565C0">💧</text><text x="140" y="115" text-anchor="middle" font-size="9" fill="#1565C0">+ eau distillée</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Peser sol et mélanger eau</text></svg>`,
        'sol_vbs_2': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="120" y="20" width="15" height="80" rx="2" fill="#1565C0" opacity="0.2" stroke="#1565C0" stroke-width="1.5"/><text x="127" y="15" text-anchor="middle" font-size="8" fill="#1565C0" font-weight="bold">Burette</text><rect x="100" y="90" width="80" height="25" rx="3" fill="#8B6914" opacity="0.2" stroke="#795548" stroke-width="1.5"/><text x="140" y="107" text-anchor="middle" font-size="8" fill="#795548">Suspension</text><path d="M 127 100 L 127 90" stroke="#0D47A1" stroke-width="2"/><circle cx="127" cy="85" r="3" fill="#0D47A1" opacity="0.6"/><text x="200" y="55" text-anchor="middle" font-size="8" fill="#FF6F00">+5 mL</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Injecter bleu par incréments</text></svg>`,
        'sol_vbs_3': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="60" r="30" fill="#FAFAFA" stroke="#BDBDBD" stroke-width="1.5"/><circle cx="140" cy="60" r="12" fill="#0D47A1" opacity="0.7"/><text x="140" y="64" text-anchor="middle" font-size="7" fill="#FFF">Tache</text><text x="140" y="100" text-anchor="middle" font-size="9" fill="#795548">Papier filtre</text><text x="140" y="115" text-anchor="middle" font-size="8" fill="#666">Goutte sur papier filtre</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Déposer goutte sur filtre</text></svg>`,
        'sol_vbs_4': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="55" r="30" fill="#FAFAFA" stroke="#BDBDBD" stroke-width="1.5"/><circle cx="140" cy="55" r="12" fill="#0D47A1" opacity="0.8"/><circle cx="140" cy="55" r="22" fill="none" stroke="#42A5F5" stroke-width="2" opacity="0.6"/><text x="140" y="59" text-anchor="middle" font-size="7" fill="#FFF">●</text><text x="200" y="45" text-anchor="middle" font-size="8" fill="#4CAF50" font-weight="bold">✅ Auréole</text><text x="200" y="58" text-anchor="middle" font-size="8" fill="#4CAF50">bleu clair</text><text x="200" y="70" text-anchor="middle" font-size="8" fill="#4CAF50">persistante</text><text x="140" y="100" text-anchor="middle" font-size="9" fill="#FF6F00" font-weight="bold">Essai positif !</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Auréole bleue = saturation</text></svg>`,
        'sol_vbs_5': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><text x="40" y="40" font-size="9" fill="#1565C0" font-weight="bold">⏱️ 5 min</text><circle cx="80" cy="70" r="18" fill="#FAFAFA" stroke="#BDBDBD" stroke-width="1"/><circle cx="80" cy="70" r="8" fill="#0D47A1" opacity="0.7"/><circle cx="80" cy="70" r="14" fill="none" stroke="#42A5F5" stroke-width="1.5" opacity="0.5"/><circle cx="140" cy="70" r="18" fill="#FAFAFA" stroke="#BDBDBD" stroke-width="1"/><circle cx="140" cy="70" r="8" fill="#0D47A1" opacity="0.7"/><circle cx="140" cy="70" r="14" fill="none" stroke="#42A5F5" stroke-width="1.5" opacity="0.5"/><circle cx="200" cy="70" r="18" fill="#FAFAFA" stroke="#BDBDBD" stroke-width="1"/><circle cx="200" cy="70" r="8" fill="#0D47A1" opacity="0.7"/><circle cx="200" cy="70" r="14" fill="none" stroke="#42A5F5" stroke-width="1.5" opacity="0.5"/><text x="80" y="100" text-anchor="middle" font-size="7" fill="#666">1 min</text><text x="140" y="100" text-anchor="middle" font-size="7" fill="#666">3 min</text><text x="200" y="100" text-anchor="middle" font-size="7" fill="#666">5 min</text><text x="140" y="120" text-anchor="middle" font-size="9" fill="#4CAF50" font-weight="bold">Vérification saturation</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Répéter pendant 5 minutes</text></svg>`,

        // BÉTON - Abrams
        'beton_abrams_1': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><path d="M 100 100 L 80 30 L 200 30 L 180 100 Z" fill="#BDBDBD" stroke="#757575" stroke-width="2"/><text x="140" y="70" text-anchor="middle" font-size="10" fill="#555" font-weight="bold">Cône d'Abrams</text><text x="140" y="25" text-anchor="middle" font-size="8" fill="#1565C0">d=100mm</text><text x="140" y="115" text-anchor="middle" font-size="8" fill="#1565C0">D=200mm, H=300mm</text><circle cx="50" cy="65" r="10" fill="#42A5F5" opacity="0.2"/><text x="50" y="69" text-anchor="middle" font-size="8" fill="#1565C0">💧</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Humidifier moule et plaque</text></svg>`,
        'beton_abrams_2': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><path d="M 100 100 L 80 20 L 200 20 L 180 100 Z" fill="#BDBDBD" stroke="#757575" stroke-width="2"/><line x1="90" y1="47" x2="190" y2="47" stroke="#E65100" stroke-width="1" stroke-dasharray="3,3"/><line x1="85" y1="73" x2="195" y2="73" stroke="#E65100" stroke-width="1" stroke-dasharray="3,3"/><text x="220" y="35" text-anchor="middle" font-size="7" fill="#E65100">Couche 1</text><text x="220" y="60" text-anchor="middle" font-size="7" fill="#E65100">Couche 2</text><text x="220" y="88" text-anchor="middle" font-size="7" fill="#E65100">Couche 3</text><rect x="135" y="5" width="6" height="95" rx="1" fill="#795548"/><text x="50" y="60" text-anchor="middle" font-size="8" fill="#FF6F00" font-weight="bold">25 coups</text><text x="50" y="72" text-anchor="middle" font-size="8" fill="#FF6F00">/couche</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">3 couches × 25 coups tige</text></svg>`,
        'beton_abrams_3': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><path d="M 100 90 L 80 20 L 200 20 L 180 90 Z" fill="#BDBDBD" stroke="#757575" stroke-width="2"/><rect x="80" y="18" width="120" height="5" fill="#9E9E9E" stroke="#757575" stroke-width="1"/><line x1="60" y1="20" x2="220" y2="20" stroke="#1565C0" stroke-width="2"/><text x="140" y="15" text-anchor="middle" font-size="9" fill="#1565C0" font-weight="bold">Arasement</text><text x="140" y="60" text-anchor="middle" font-size="9" fill="#555">Béton rempli</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Araser au sommet du cône</text></svg>`,
        'beton_abrams_4': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><path d="M 50 90 L 30 20 L 110 20 L 90 90 Z" fill="#BDBDBD" stroke="#757575" stroke-width="2" opacity="0.4"/><path d="M 50 20 L 50 5" stroke="#1565C0" stroke-width="2" marker-end="url(#arrowR)"/><text x="70" y="10" text-anchor="middle" font-size="8" fill="#1565C0" font-weight="bold">↑ Soulever</text><ellipse cx="190" cy="85" rx="50" ry="15" fill="#9E9E9E" opacity="0.5" stroke="#757575" stroke-width="1.5"/><path d="M 165 85 Q 190 50 215 85" fill="#9E9E9E" opacity="0.4"/><text x="190" y="80" text-anchor="middle" font-size="9" fill="#555" font-weight="bold">Béton affaissé</text><text x="190" y="110" text-anchor="middle" font-size="8" fill="#666">5-10 secondes</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Soulever verticalement</text></svg>`,
        'beton_abrams_5': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><line x1="60" y1="20" x2="220" y2="20" stroke="#E65100" stroke-width="1.5" stroke-dasharray="4,3"/><text x="240" y="24" text-anchor="middle" font-size="8" fill="#E65100">300mm</text><ellipse cx="140" cy="85" rx="55" ry="15" fill="#9E9E9E" opacity="0.5" stroke="#757575" stroke-width="1.5"/><path d="M 115 85 Q 140 50 165 85" fill="#9E9E9E" opacity="0.4"/><line x1="140" y1="20" x2="140" y2="55" stroke="#FF6F00" stroke-width="2.5"/><text x="155" y="40" text-anchor="middle" font-size="9" fill="#FF6F00" font-weight="bold">Slump</text><path d="M 130 20 L 140 20 L 140 55 L 150 55" stroke="#FF6F00" stroke-width="1.5" fill="none"/><text x="140" y="110" text-anchor="middle" font-size="9" fill="#4CAF50" font-weight="bold">Classe S1 à S5</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Mesurer l'affaissement</text></svg>`,

        // BÉTON - Compression
        'beton_rc_1': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="90" y="40" width="100" height="50" rx="3" fill="#42A5F5" opacity="0.15" stroke="#1565C0" stroke-width="1.5"/><text x="140" y="60" text-anchor="middle" font-size="9" fill="#1565C0" font-weight="bold">Bac de cure</text><text x="140" y="75" text-anchor="middle" font-size="8" fill="#1565C0">20 ± 2 °C</text><rect x="120" y="50" width="40" height="30" rx="3" fill="#9E9E9E" stroke="#757575" stroke-width="1.5"/><text x="140" y="100" text-anchor="middle" font-size="9" fill="#795548">Sortir éprouvette</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Sortir du bac de cure</text></svg>`,
        'beton_rc_2': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="100" y="35" width="80" height="60" rx="20" fill="#9E9E9E" stroke="#757575" stroke-width="2"/><text x="140" y="70" text-anchor="middle" font-size="9" fill="#FFF" font-weight="bold">Cylindre</text><text x="140" y="25" text-anchor="middle" font-size="8" fill="#1565C0">16×32 cm</text><rect x="80" y="100" width="120" height="8" rx="2" fill="#E0E0E0" stroke="#BDBDBD" stroke-width="1"/><text x="140" y="125" text-anchor="middle" font-size="8" fill="#666">Vérifier planéité</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Essuyer et vérifier faces</text></svg>`,
        'beton_rc_3': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="80" y="10" width="120" height="15" rx="2" fill="#757575" stroke="#555" stroke-width="2"/><rect x="80" y="85" width="120" height="15" rx="2" fill="#757575" stroke="#555" stroke-width="2"/><rect x="110" y="25" width="60" height="60" rx="15" fill="#9E9E9E" stroke="#757575" stroke-width="1.5"/><text x="140" y="60" text-anchor="middle" font-size="9" fill="#FFF" font-weight="bold">Éprouvette</text><path d="M 140 10 L 140 25" stroke="#FF5722" stroke-width="2" marker-end="url(#arrowR)"/><text x="55" y="55" text-anchor="middle" font-size="8" fill="#E65100" font-weight="bold">Presse</text><text x="140" y="115" text-anchor="middle" font-size="9" fill="#1565C0">Centrer sur plateaux</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Placer centré sur la presse</text></svg>`,
        'beton_rc_4': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="80" y="10" width="120" height="12" rx="2" fill="#757575" stroke="#555" stroke-width="2"/><rect x="80" y="78" width="120" height="12" rx="2" fill="#757575" stroke="#555" stroke-width="2"/><rect x="110" y="22" width="60" height="56" rx="12" fill="#9E9E9E" stroke="#757575" stroke-width="1.5"/><path d="M 140 10 L 140 22" stroke="#FF5722" stroke-width="3"/><path d="M 135 40 L 170 60" stroke="#FF5722" stroke-width="1.5"/><path d="M 110 35 L 145 70" stroke="#FF5722" stroke-width="1.5"/><text x="140" y="55" text-anchor="middle" font-size="7" fill="#FF5722" font-weight="bold">Fissures</text><text x="140" y="110" text-anchor="middle" font-size="9" fill="#E65100" font-weight="bold">Rupture !</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Compression jusqu'à rupture</text></svg>`,
        'beton_rc_5': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="60" y="30" width="160" height="60" rx="5" fill="#E8F5E9" stroke="#4CAF50" stroke-width="1.5"/><text x="140" y="50" text-anchor="middle" font-size="10" fill="#2E7D32" font-weight="bold">Résultat</text><text x="140" y="68" text-anchor="middle" font-size="12" fill="#1565C0" font-weight="bold">Rc = F / S (MPa)</text><text x="140" y="82" text-anchor="middle" font-size="8" fill="#666">F (kN) ÷ S (cm²) × 10</text><text x="140" y="105" text-anchor="middle" font-size="9" fill="#FF6F00">Mode: Cône, cisaillement...</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Noter force et mode rupture</text></svg>`,

        // GRANULATS - Los Angeles
        'granulat_la_1': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="80" y="40" width="120" height="50" rx="4" fill="#8B6914" opacity="0.3" stroke="#795548" stroke-width="1.5"/><text x="140" y="70" text-anchor="middle" font-size="10" fill="#5D4037" font-weight="bold">5000g gravillons</text><rect x="40" y="45" width="30" height="40" rx="3" fill="#2196F3" opacity="0.15" stroke="#1565C0" stroke-width="1.5"/><text x="55" y="70" text-anchor="middle" font-size="10" fill="#1565C0">⚖️</text><text x="140" y="110" text-anchor="middle" font-size="9" fill="#FF6F00" font-weight="bold">M0 = 5000g</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Peser 5000g calibrés</text></svg>`,
        'granulat_la_2': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="60" r="45" fill="#E0E0E0" stroke="#757575" stroke-width="2"/><circle cx="125" cy="50" r="6" fill="#555"/><circle cx="145" cy="65" r="6" fill="#555"/><circle cx="155" cy="45" r="6" fill="#555"/><circle cx="135" cy="75" r="6" fill="#555"/><text x="140" y="60" text-anchor="middle" font-size="7" fill="#FFF" font-weight="bold">Boulets</text><text x="140" y="115" text-anchor="middle" font-size="9" fill="#1565C0" font-weight="bold">Tambour Los Angeles</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Charger gravillons + boulets</text></svg>`,
        'granulat_la_3': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="60" r="45" fill="#E0E0E0" stroke="#757575" stroke-width="2"/><path d="M 100 35 A 45 45 0 0 1 180 35" fill="none" stroke="#1565C0" stroke-width="2" marker-end="url(#arrowR)"/><text x="140" y="25" text-anchor="middle" font-size="8" fill="#1565C0" font-weight="bold">500 rotations</text><text x="140" y="65" text-anchor="middle" font-size="9" fill="#555">31 tr/min</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">500 rotations exactes</text></svg>`,
        'granulat_la_4': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="60" y="50" width="160" height="8" rx="2" fill="#1565C0" opacity="0.3"/><text x="140" y="45" text-anchor="middle" font-size="9" fill="#1565C0" font-weight="bold">Tamis 1.6 mm</text><circle cx="90" cy="70" r="5" fill="#42A5F5" opacity="0.3"/><circle cx="110" cy="75" r="4" fill="#42A5F5" opacity="0.3"/><text x="140" y="80" text-anchor="middle" font-size="8" fill="#795548">Lavage soigneux</text><path d="M 100 58 L 90 70 M 140 58 L 140 70 M 180 58 L 170 70" stroke="#8B6914" stroke-width="1" opacity="0.5"/><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Laver sur tamis 1.6mm</text></svg>`,
        'granulat_la_5': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="70" y="30" width="140" height="60" rx="5" fill="#E8F5E9" stroke="#4CAF50" stroke-width="1.5"/><text x="140" y="50" text-anchor="middle" font-size="9" fill="#2E7D32" font-weight="bold">Résultat</text><text x="140" y="68" text-anchor="middle" font-size="11" fill="#1565C0" font-weight="bold">LA = (M0-M1)/M0 × 100</text><text x="140" y="82" text-anchor="middle" font-size="8" fill="#666">Sécher à 110°C → peser M1</text><text x="140" y="110" text-anchor="middle" font-size="9" fill="#FF6F00">LA ≤ 25% → Conforme ✅</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Sécher, peser, calculer LA%</text></svg>`,

        // ENROBÉS - Marshall
        'enrobe_marshall_1': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="100" y="40" width="80" height="50" rx="20" fill="#333" stroke="#555" stroke-width="2"/><text x="140" y="70" text-anchor="middle" font-size="8" fill="#FFF" font-weight="bold">Enrobé chaud</text><rect x="130" y="10" width="10" height="30" rx="2" fill="#795548"/><text x="135" y="7" text-anchor="middle" font-size="7" fill="#E65100">Dame</text><text x="140" y="105" text-anchor="middle" font-size="8" fill="#FF6F00">50 coups/face</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Compacter dans moule Marshall</text></svg>`,
        'enrobe_marshall_2': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="100" y="50" width="80" height="35" rx="20" fill="#333" stroke="#555" stroke-width="1.5"/><text x="140" y="72" text-anchor="middle" font-size="8" fill="#FFF">Éprouvette</text><text x="55" y="55" text-anchor="middle" font-size="8" fill="#1565C0">📏 h</text><path d="M 70 50 L 70 85" stroke="#1565C0" stroke-width="1.5" marker-start="url(#arrowR)" marker-end="url(#arrowR)"/><text x="220" y="55" text-anchor="middle" font-size="8" fill="#1565C0">📏 ∅</text><path d="M 100 95 L 180 95" stroke="#1565C0" stroke-width="1.5"/><text x="140" y="115" text-anchor="middle" font-size="9" fill="#795548">Mesurer dimensions</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Démouler et mesurer</text></svg>`,
        'enrobe_marshall_3': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="60" y="35" width="160" height="55" rx="5" fill="#42A5F5" opacity="0.15" stroke="#1565C0" stroke-width="1.5"/><text x="140" y="55" text-anchor="middle" font-size="10" fill="#1565C0" font-weight="bold">Bain-marie</text><text x="140" y="72" text-anchor="middle" font-size="9" fill="#E65100">60 ± 1 °C</text><text x="140" y="83" text-anchor="middle" font-size="8" fill="#666">40 minutes</text><rect x="120" y="45" width="40" height="25" rx="10" fill="#333" opacity="0.6"/><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Bain-marie à 60°C, 40 min</text></svg>`,
        'enrobe_marshall_4': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><rect x="100" y="30" width="80" height="70" rx="5" fill="#E0E0E0" stroke="#757575" stroke-width="2"/><path d="M 100 65 Q 80 65 80 50 Q 80 35 100 35" fill="none" stroke="#757575" stroke-width="3"/><path d="M 180 65 Q 200 65 200 50 Q 200 35 180 35" fill="none" stroke="#757575" stroke-width="3"/><rect x="115" y="42" width="50" height="20" rx="10" fill="#333" opacity="0.7"/><text x="140" y="56" text-anchor="middle" font-size="7" fill="#FFF">Éprouvette</text><text x="140" y="115" text-anchor="middle" font-size="9" fill="#1565C0" font-weight="bold">Mâchoires Marshall</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Placer dans mâchoires presse</text></svg>`,
        'enrobe_marshall_5': `<svg viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg"><line x1="40" y1="105" x2="240" y2="105" stroke="#666" stroke-width="1.5"/><line x1="40" y1="20" x2="40" y2="105" stroke="#666" stroke-width="1.5"/><text x="140" y="125" text-anchor="middle" font-size="8" fill="#666">Déformation (mm)</text><text x="25" y="60" text-anchor="middle" font-size="7" fill="#666" transform="rotate(-90,25,60)">Force</text><path d="M 40 100 L 80 60 L 130 35 L 160 40 L 200 70" fill="none" stroke="#1565C0" stroke-width="2.5"/><circle cx="130" cy="35" r="5" fill="#FF6F00" stroke="#E65100" stroke-width="1.5"/><text x="145" y="30" text-anchor="middle" font-size="7" fill="#FF6F00" font-weight="bold">Stabilité</text><line x1="130" y1="40" x2="130" y2="105" stroke="#FF6F00" stroke-width="1" stroke-dasharray="3,3"/><text x="130" y="115" text-anchor="middle" font-size="7" fill="#4CAF50">Fluage</text><text x="140" y="130" text-anchor="middle" font-size="10" fill="#666">Enregistrer Stabilité/Fluage</text></svg>`,
    };

    // Return matching diagram or generate a generic one
    if (diagrams[key]) {
        return `<div class="step-svg-diagram">${diagrams[key]}</div>`;
    }
    
    // Generic fallback diagram based on step number
    const colors = ['#1565C0', '#FF6F00', '#4CAF50', '#E65100', '#7B1FA2'];
    const color = colors[(stepNum - 1) % colors.length];
    const icons = ['🔬', '⚗️', '📏', '🧪', '📊'];
    const icon = icons[(stepNum - 1) % icons.length];
    
    return `<div class="step-svg-diagram">
        <svg viewBox="0 0 280 100" xmlns="http://www.w3.org/2000/svg">
            <rect x="40" y="10" width="200" height="70" rx="10" fill="${color}" opacity="0.08" stroke="${color}" stroke-width="1.5" stroke-dasharray="5,3"/>
            <text x="140" y="45" text-anchor="middle" font-size="24">${icon}</text>
            <text x="140" y="65" text-anchor="middle" font-size="9" fill="${color}" font-weight="bold">Étape ${stepNum}</text>
            <text x="140" y="95" text-anchor="middle" font-size="8" fill="#999">Schéma technique</text>
        </svg>
    </div>`;
}
...
function openTestDetails(testId) {
    ...
    // Section 6: Embedded YouTube Video Player
    const aiPromptBox = document.getElementById('detail-ai-prompt');
    const videoQuery = encodeURIComponent(test.youtubeQuery);
    aiPromptBox.innerHTML = `
        ...
        <p style="font-size:10px; color:var(--md-outline); margin-top:6px; text-align:center;">
            🎬 Vidéo éducative : ${test.name} - Procédure de laboratoire
        </p>
    `;
    
    const aiBtn = document.getElementById('detail-ai-btn');
    aiBtn.innerHTML = '🎬 Voir plus de vidéos';
    aiBtn.onclick = () => {
        window.open(`https://youtube.com/results?search_query=${videoQuery}`, '_blank');
    };
